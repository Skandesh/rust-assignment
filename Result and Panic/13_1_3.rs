//This will display all the call stack and the whole windings happening.
use std::env;
fn main() {
    ...
    divide(15, 0); //division by 0 is not possible
...
fn production_rate_per_hour(speed: u16) -> f64 {
    let cph: u16 = 221; // changed to u16 from u8 as 221 * 2  would result in overflow for u8
    match speed {
